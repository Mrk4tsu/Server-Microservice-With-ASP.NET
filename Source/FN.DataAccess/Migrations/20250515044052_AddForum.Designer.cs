...
namespace FN.DataAccess.Migrations
{
    ...
    [Migration("20250515044052_AddForum")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("TimeCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 11, 40, 51, 260, DateTimeKind.Local).AddTicks(6495));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.FeedBack", b =>
                {
                    ...
                    b.Property<DateTime>("TimeCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 11, 40, 51, 262, DateTimeKind.Local).AddTicks(3093));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.Item", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 11, 40, 51, 263, DateTimeKind.Local).AddTicks(3229));
                    ...
                    b.Property<DateTime>("ModifiedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 11, 40, 51, 263, DateTimeKind.Local).AddTicks(3811));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.Payment", b =>
                {
                    ...
                    b.Property<DateTime>("PaymentDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 11, 40, 51, 264, DateTimeKind.Local).AddTicks(9972));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.ProductPrice", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 4, 40, 51, 268, DateTimeKind.Utc).AddTicks(672));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.Reply", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 4, 40, 51, 272, DateTimeKind.Utc).AddTicks(1076));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 4, 40, 51, 272, DateTimeKind.Utc).AddTicks(1762));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.SaleEvent", b =>
                {
                    ...
                    b.Property<DateTime>("EndDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 22, 4, 40, 51, 268, DateTimeKind.Utc).AddTicks(6494));
                    ...
                    b.Property<DateTime>("StartDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 4, 40, 51, 268, DateTimeKind.Utc).AddTicks(5952));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.Topic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("CreatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 4, 40, 51, 271, DateTimeKind.Utc).AddTicks(2934));
                    ...
                    b.Property<DateTime>("UpdatedAt")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 4, 40, 51, 271, DateTimeKind.Utc).AddTicks(3680));
                    ...
                    b.HasIndex("IsDeleted")
                        .HasDatabaseName("IX_Topics_IsDeleted");

                    b.HasIndex("IsLocked")
                        .HasDatabaseName("IX_Topics_IsLocked");

                    b.HasIndex("UpdatedAt")
                        .HasDatabaseName("IX_Topics_UpdatedAt");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_Topics_UserId");
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.UserBlogInteraction", b =>
                {
                    ...
                    b.Property<DateTime>("InteractionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 11, 40, 51, 269, DateTimeKind.Local).AddTicks(8387));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.UserOrder", b =>
                {
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 11, 40, 51, 264, DateTimeKind.Local).AddTicks(245));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.UserProductInteraction", b =>
                {
                    ...
                    b.Property<DateTime>("InteractionDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2025, 5, 15, 4, 40, 51, 270, DateTimeKind.Utc).AddTicks(5136));
            ...
            modelBuilder.Entity("FN.DataAccess.Entities.Reply", b =>
                {
                    b.HasOne("FN.DataAccess.Entities.Reply", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");

                    b.HasOne("FN.DataAccess.Entities.Topic", "Topic")
                        .WithMany("Replies")
