...
namespace FN.AIService.Controllers
{
    ...
    public class BasesController : ControllerBase
    {
        ...
        public static IActionResult Error(string? message = null, Code statusCode = Code.BadRequest, object? data = null)
        {
        ...
        public static IActionResult NotFound(string? message = null, object? data = null)
        {
            return new ObjectResult(new
            {
                success = false,
